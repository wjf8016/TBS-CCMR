...
class Recommender(object):
    ...
    def print_model_info(self):
        ...
        if self.config['model.type'] == 'MultiBehavior':
            print('Training Set:', abspath(self.config['training_p.set']))
            print('Training Set:', abspath(self.config['training_c.set']))
            print('Training Set:', abspath(self.config['training_v.set']))
